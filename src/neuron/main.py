...
train_path = "src/aircrafts_and_ships/train"
test_path = "src/aircrafts_and_ships/test"
...
for epoch in range(epochs):
    ...
    if test_loss < best_loss:
        torch.save(pretrained_resnet50, "src/run_classifier/resnet50_best_loss.pth")